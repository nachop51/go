...
CREATE TABLE cats (
  ...
  weight INT NOT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (breed_id) REFERENCES cat_breeds (id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE dogs (
  ...
  weight INT NOT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (breed_id) REFERENCES dog_breeds (id) ON DELETE SET NULL ON UPDATE CASCADE,
  FOREIGN KEY (breeder_id) REFERENCES breeders (id) ON DELETE SET NULL ON UPDATE CASCADE
);
